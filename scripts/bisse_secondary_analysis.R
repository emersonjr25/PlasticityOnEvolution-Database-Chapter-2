...
# mu 1 x mu 2 #
bf_mean(mean_posteriors[3], mean_posteriors[4])
...
if(save_result == TRUE){
  tiff(filename = file.path(here('output'), paste0('markov_result_bisse', ".tif")),
       #width = 1000,
...
markov_lambda <- ggplot(mcmc_result, aes(x=i)) +
  geom_line(aes(y=lambda0), color='blue') +
  geom_line(aes(y=lambda1), color='black') +
...
if(save_result == TRUE){
  tiff(filename = file.path(here('output'), paste0('markov_result_lambda_bisse', ".tif")),
       #width = 1000,
       width = 800, #without abundance and occupancy
       height = 600,
       #height = 400, #abundance and occupancy
...
if(save_result == TRUE){
  tiff(filename = file.path(here('output'), paste0('transition_bisse', ".tif")),
       #width = 1000,
       width = 800, #without abundance and occupancy
       height = 600,
       #height = 400, #abundance and occupancy
...
if(save_result == TRUE){
  tiff(filename = file.path(here('output'), paste0('speciation_bisse', ".tif")),
       #width = 1000,
       width = 800, #without abundance and occupancy
       height = 600,
       #height = 400, #abundance and occupancy
...
if(save_result == TRUE){
  tiff(filename = file.path(here('output'), paste0('extinction_bisse', ".tif")),
       #width = 1000,
       width = 800, #without abundance and occupancy
       height = 600,
       #height = 400, #abundance and occupancy
...
if(save_result == TRUE){
  tiff(filename = file.path(here('output'), paste0('diversification_bisse', ".tif")),
       #width = 1000,
       width = 800, #without abundance and occupancy
       height = 600,
       #height = 400, #abundance and occupancy
